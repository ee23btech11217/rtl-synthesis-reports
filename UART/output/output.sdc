...
#  Created by Genus(TM) Synthesis Solution 20.10-p001_1 on Wed Nov 20 19:39:43 IST 2024
...
set_multicycle_path -from [list \
  [get_ports {Prescale[0]}]  \
  [get_ports {Prescale[1]}]  \
  [get_ports {Prescale[2]}]  \
  [get_ports {Prescale[3]}]  \
  [get_ports {Prescale[4]}]  \
  [get_ports {Prescale[5]}]  \
  [get_ports parity_enable]  \
  [get_ports parity_type] ] -setup -end 2
...
set_driving_cell -lib_cell BUFX2 -library fast_vdd1v0 -pin "Y" [get_ports RX_IN_S]
set_driving_cell -lib_cell BUFX2 -library fast_vdd1v0 -pin "Y" [get_ports {TX_IN_P[7]}]
set_driving_cell -lib_cell BUFX2 -library fast_vdd1v0 -pin "Y" [get_ports {TX_IN_P[6]}]
set_driving_cell -lib_cell BUFX2 -library fast_vdd1v0 -pin "Y" [get_ports {TX_IN_P[5]}]
set_driving_cell -lib_cell BUFX2 -library fast_vdd1v0 -pin "Y" [get_ports {TX_IN_P[4]}]
set_driving_cell -lib_cell BUFX2 -library fast_vdd1v0 -pin "Y" [get_ports {TX_IN_P[3]}]
set_driving_cell -lib_cell BUFX2 -library fast_vdd1v0 -pin "Y" [get_ports {TX_IN_P[2]}]
set_driving_cell -lib_cell BUFX2 -library fast_vdd1v0 -pin "Y" [get_ports {TX_IN_P[1]}]
set_driving_cell -lib_cell BUFX2 -library fast_vdd1v0 -pin "Y" [get_ports {TX_IN_P[0]}]
